  ...
  return (
    <div className="bph">
      ...
      <section className="bph-hero" ref={heroRef} onMouseMove={handleHeroMouseMove}>
        ...
        {/* Cursor-reactive purple glow (desktop only) */}
        ...
        <div style={{ position: 'absolute', inset: 0, zIndex: 0 }}>
          ...
          {/* Cursor spotlight reveals the true, full-colour photo beneath the moody grade */}
          <img
            src="https://images.unsplash.com/photo-1503951914875-452162b0f3f1?w=1920&h=1280&fit=crop&q=80"
            alt=""
            aria-hidden="true"
      ...
      */}
      ...
      <style>{`
        ...
        .bph-cursor-glow {
          ...
          background: radial-gradient(circle 320px at var(--mx, 50%) var(--my, 50%), rgba(178,102,255,0.12), transparent 70%);
        }
        @media (hover: none), (pointer: coarse) { .bph-cursor-glow { display: none; } }

        /* Cursor spotlight reveal — true-colour photo beneath the moody grade */
        .bph-spotlight-img {
        ...
        .bph-spotlight-ring {
          ...
          box-shadow: 0 0 0 1px rgba(243,236,251,0.08) inset, 0 0 40px rgba(178,102,255,0.25);
          opacity: 0;
        ...
        .bph-next-slot {
          ...
          background: rgba(243,236,251,0.05);
          border: 1px solid rgba(178,102,255,0.30);
          border-radius: 999px;
          text-decoration: none;
          transition: all 0.3s ease;
        }
        .bph-next-slot:hover { background: rgba(178,102,255,0.10); border-color: var(--gold); transform: translateY(-1px); }
        .bph-next-slot-dot {
          width: 8px; height: 8px; border-radius: 50%; flex-shrink: 0;
          background: var(--gold); box-shadow: 0 0 10px rgba(178,102,255,0.7);
          animation: pulse-wa 2.4s ease-in-out infinite;
        }
        ...
        .bph-lightbox-close {
          ...
          background: rgba(243,236,251,0.06); border: 1px solid var(--line);
          color: var(--cream-dim); font-size: 1rem; cursor: pointer;
          display: flex; align-items: center; justify-content: center;
          transition: all 0.25s ease;
        }
        .bph-lightbox-close:hover { color: var(--gold-light); border-color: var(--gold); background: rgba(178,102,255,0.1); }
        .bph-lightbox-nav {
          width: 48px; height: 48px; border-radius: 50%; flex-shrink: 0;
          background: rgba(243,236,251,0.05); border: 1.5px solid rgba(243,236,251,0.16);
          color: var(--cream-dim); font-size: 1.3rem; font-weight: 600; cursor: pointer;
          display: flex; align-items: center; justify-content: center;
          margin: 0 clamp(0.5rem, 2vw, 1.5rem);
          transition: all 0.25s ease;
        }
        .bph-lightbox-nav:hover { border-color: var(--gold); color: var(--gold-light); background: rgba(178,102,255,0.1); }
